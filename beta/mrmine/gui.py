...
|==================================================================================================================================================|""")
		...
		os.system('clear')
		i=1
		while i<=len(save_data['UNLOCKED']):
			print(get_sprite(i)+'\n'+save_data['MINERALS'][0])
			i+=1
		mineral=input(f'What mineral would you like to sell? (1-{len(save_data['UNLOCKED'])}) > ').lower()
		if mineral>=1 and mineral<=len(save_data['UNLOCKED']):
