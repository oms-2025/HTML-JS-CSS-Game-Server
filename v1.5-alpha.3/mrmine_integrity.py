def m_ic_initialize():
  ...
  spriteerror=0
  savewritererror=0
  lines_in_file = open('/workspaces/coolmathgames/v1.5-alpha.3/mrmine/main_script.py', 'r').readlines()
  ...
  if not number_of_lines==mainlines:
    mainerror=1
  lines_in_file = open('/workspaces/coolmathgames/v1.5-alpha.3/mrmine/gui.py', "r").readlines()
  number_of_lines = len(lines_in_file)
  ...
  if not number_of_lines==guilines:
    guierror=1
  lines_in_file = open('/workspaces/coolmathgames/v1.5-alpha.3/mrmine/keypress_detector.py', "r").readlines()
  number_of_lines = len(lines_in_file)
  ...
  if not number_of_lines==keypresslines:
    keypresserror=1
  lines_in_file = open('/workspaces/coolmathgames/v1.5-alpha.3/mrmine_integrity.py', "r").readlines()
  number_of_lines = len(lines_in_file)
  ...
  if not number_of_lines==integritylines:
    integrityerror=1
  lines_in_file = open('/workspaces/coolmathgames/v1.5-alpha.3/launcher.py', "r").readlines()
  number_of_lines = len(lines_in_file)
  ...
  if not number_of_lines==launcherlines:
    launchererror=1
  lines_in_file = open('/workspaces/coolmathgames/v1.5-alpha.3/mrmine/sprites.py', 'r').readlines()
  number_of_lines = len(lines_in_file)
  ...
  if not number_of_lines==spritelines:
    spriteerror=1
  lines_in_file = open('/workspaces/coolmathgames/v1.5-alpha.3/mrmine/save.py', 'r').readlines()
  number_of_lines = len(lines_in_file)
