def m_ic_initialize():
  ...
  integrityerror=0
  launchererror=0
  lines_in_file = open('/workspaces/coolmathgames/v1.4-alpha.2/mrmine/main_script.py', 'r').readlines()
  ...
  if not number_of_lines==mainlines:
    mainerror=1
  lines_in_file = open('/workspaces/coolmathgames/v1.4-alpha.2/mrmine/gui.py', "r").readlines()
  number_of_lines = len(lines_in_file)
  ...
  if not number_of_lines==guilines:
    guierror=1
  lines_in_file = open('/workspaces/coolmathgames/v1.4-alpha.2/mrmine/keypress_detector.py', "r").readlines()
  number_of_lines = len(lines_in_file)
  ...
  if not number_of_lines==keypresslines:
    keypresserror=1
  lines_in_file = open('/workspaces/coolmathgames/v1.4-alpha.2/mrmine_integrity.py', "r").readlines()
  number_of_lines = len(lines_in_file)
  ...
  if not number_of_lines==integritylines:
    integrityerror=1
  lines_in_file = open('/workspaces/coolmathgames/v1.4-alpha.2/launcher.py', "r").readlines()
  number_of_lines = len(lines_in_file)
